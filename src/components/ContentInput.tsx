...
export const ContentInput = ({ onGenerate, loading }: ContentInputProps) => {
          ...
          <div className="flex flex-col h-full p-6 space-y-6">
            ...
            <div className="space-y-4 flex-1 flex flex-col">
              ...
              <div className="space-y-2 flex-1 flex flex-col">
                ...
                import {z} from "zod";
                import {toast} from "sonner";
                import {LRMVisualizer} from "@/components/LRMVisualizer"; // Added this import based on the desired final state
  ...
  const [title, setTitle] = useState("");
                const [content, setContent] = useState("");
                const [errors, setErrors] = useState<{ [key: string]: string }>({ });
                const [lrmProcessing, setLrmProcessing] = useState(false); // Added this state
                const [lrmData, setLrmData] = useState<any>(null); // Added this state

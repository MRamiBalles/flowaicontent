...
import { ArrowRight, Video, Coins, TrendingUp, Users, Zap, Shield, Sparkles, Play, Star, CheckCircle2 } from "lucide-react";
const Index = () => {
  ...
  return <div className="min-h-screen bg-background">
      ...
      <section id="features" className="py-24 px-6 bg-card/30">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {features.map((feature, i) => <Card key={i} className={`border-border/50 bg-card/50 backdrop-blur-sm hover:shadow-lg transition-all duration-300 hover:-translate-y-1`}>
      ...
      <section id="pricing" className="py-24 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            {pricingPlans.map((plan, i) => <Card key={i} className={`relative border-border/50 bg-card/50 backdrop-blur-sm ${plan.popular ? 'border-primary shadow-lg shadow-primary/10' : ''}`}>
      ...
      <footer className="py-12 px-6 border-t border-border/50">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <p className="text-sm text-muted-foreground">© 2025 FlowAI. All rights reserved.</p>
        </div>
      </footer>
    </div>;
};
